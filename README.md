# jupyter-filebrowser-proxy

[![TravisCI build status](https://img.shields.io/travis/com/jupyterhub/jupyter-filebrowser-proxy?logo=travis)](https://travis-ci.com/jupyterhub/jupyter-filebrowser-proxy)

**jupyter-filebrowser-proxy** provides Jupyter server and notebook extensions to proxy RStudio.

![Screenshot](screenshot.png)

If you have a JupyterHub deployment, jupyter-filebrowser-proxy can take advantage of JupyterHub's existing authenticator and spawner to launch RStudio in users' Jupyter environments. You can also run this from within Jupyter.
...
### Install jupyter-filebrowser-proxy

Install the library via `pip`:
```
pip install jupyter-filebrowser-proxy
```
Or via `conda`:
```
conda install -c conda-forge jupyter-filebrowser-proxy
```
